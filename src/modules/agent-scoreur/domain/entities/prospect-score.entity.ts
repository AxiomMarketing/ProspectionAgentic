...
export class ProspectScore {
  ...
  get firmographicScore(): number { return this.props.firmographicScore; }
  get technographicScore(): number { return this.props.technographicScore; }
  get behavioralScore(): number { return this.props.behavioralScore; }
  get engagementScore(): number { return this.props.engagementScore; }
  get intentScore(): number { return this.props.intentScore; }
  get accessibilityScore(): number { return this.props.accessibilityScore; }
  ...
  toPlainObject(): ProspectScoreProps { return { ...this.props }; }
}
