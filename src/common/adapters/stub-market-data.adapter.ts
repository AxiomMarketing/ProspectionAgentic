...
import { IMarketDataAdapter, FetchOpportunitiesRequest, MarketOpportunity } from '@common/ports/i-market-data.adapter';
...
export class StubMarketDataAdapter extends IMarketDataAdapter {
  ...
  async fetchRecentOpportunities(_request: FetchOpportunitiesRequest): Promise<MarketOpportunity[]> {
